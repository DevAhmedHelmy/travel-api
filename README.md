...
Clone the repository
    ...
    git clone https://github.com/DevAhmedHelmy/travel-api
...
**TL;DR command list**
    ...
    git clone git clone https://github.com/DevAhmedHelmy/travel-api
    cd travel-api
    composer install
    cp .env.example .env
    php artisan key:generate
...
docker-compose exec php php passport:install
